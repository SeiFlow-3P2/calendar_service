...
const (
	CalendarService_CreateCalendar_FullMethodName  = "/calendar_v1.CalendarService/CreateCalendar"
	CalendarService_GetCalendars_FullMethodName    = "/calendar_v1.CalendarService/GetCalendars"
	CalendarService_GetCalendarInfo_FullMethodName = "/calendar_v1.CalendarService/GetCalendarInfo"
	CalendarService_UpdateCalendar_FullMethodName  = "/calendar_v1.CalendarService/UpdateCalendar"
	CalendarService_DeleteCalendar_FullMethodName  = "/calendar_v1.CalendarService/DeleteCalendar"
...
type CalendarServiceClient interface {
	...
	GetCalendarInfo(ctx context.Context, in *GetCalendarInfoRequest, opts ...grpc.CallOption) (*CalendarResponse, error)
...
func (c *calendarServiceClient) GetCalendarInfo(ctx context.Context, in *GetCalendarInfoRequest, opts ...grpc.CallOption) (*CalendarResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CalendarResponse)
	err := c.cc.Invoke(ctx, CalendarService_GetCalendarInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *calendarServiceClient) DeleteCalendar(ctx context.Context, in *DeleteCalendarRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type CalendarServiceServer interface {
	...
	GetCalendarInfo(context.Context, *GetCalendarInfoRequest) (*CalendarResponse, error)
...
func (UnimplementedCalendarServiceServer) GetCalendarInfo(context.Context, *GetCalendarInfoRequest) (*CalendarResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCalendarInfo not implemented")
}
...
func (UnimplementedCalendarServiceServer) DeleteCalendar(context.Context, *DeleteCalendarRequest) (*emptypb.Empty, error) {
...
func _CalendarService_GetCalendarInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCalendarInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CalendarServiceServer).GetCalendarInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CalendarService_GetCalendarInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalendarServiceServer).GetCalendarInfo(ctx, req.(*GetCalendarInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CalendarService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetCalendarInfo",
			Handler:    _CalendarService_GetCalendarInfo_Handler,
		},
		{
